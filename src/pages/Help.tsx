      ...
      <main className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        ...
        <section className="bg-white p-8 rounded-xl shadow-md border-l-8 border-purple-400">
          ...
          <ol className="list-decimal list-inside text-gray-800 space-y-3 pl-5">
            <li><strong>Browse Faculty:</strong> Look through department directories or research centers for professors doing work that interests you.</li>
            <li><strong>Shortlist Faculty:</strong> Make a list of 3-5 whose work aligns with your interests, even if it&apos;s outside your major.</li>
            <li><strong>Send a Thoughtful Email:</strong> Introduce yourself, explain your interest, and include:
            ...
            <li><strong>Follow Up:</strong> If you don&apos;t hear back in 1-2 weeks, politely follow up or try another faculty member.</li>
          </ol>
        </section>
